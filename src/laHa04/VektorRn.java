...
/**
 * Speichert einen n Dimensionalen Vektor und stellt grundlegende Rechenoperationen zur Verfügung.
 * @author chanebaum
 *
 */
...
public class VektorRn {
	...
	/**Addiert den uebergebenen Vektor zum this Vektor und gibt den Ergebnisvektor zurueck.
	 * @param v2 addiert Vektor v2 zum this Vektor
	 * @return v2 + this
	 * @throws RuntimeException falls Dimensionen nicht konsistent
	 */
	public VektorRn add(VektorRn v2) {
		if (vektor.length != v2.vektor.length)
			throw new RuntimeException();

		double v[] = new double[vektor.length];
		for (int i = 0; i < v.length; i++) {
			v[i] = vektor[i] + v2.vektor[i];
		}
	...
	/**Multipliziert den this Vektor mit einem Skalar und gibt den Ergebnisvektor zurueck.
